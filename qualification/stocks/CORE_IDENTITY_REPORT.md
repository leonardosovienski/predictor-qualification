...
Fontes: `qualification/stocks/RAW_LOGS/cleanroom-final/run35954279991/stocks-runtime-linux-primary/core_identity.json` e `qualification/stocks/RAW_LOGS/cleanroom-final/run35954279991/stocks-runtime-windows-latest/core_identity.json`;
lock conferido por `uv lock --check` (`qualification/stocks/RAW_LOGS/cleanroom-final/run35954279991/stocks-runtime-linux-primary/uv_lock_check.log`) e instalação por
`pip install --require-hashes -r` do lock exportado (`qualification/stocks/RAW_LOGS/cleanroom-final/run35954279991/stocks-runtime-linux-primary/requirements.locked.txt`).
...
| Linux primário (ubuntu-latest) | stocks-predictor | 0.3.0rc2 | `92cb1131b4f0ba0b4572d26cb03a1647e239a17f37514c0db1598797119366a8` | — (o próprio pacote) | wheel da release v0.3.0rc2 | True | False |
...
| windows-latest | stocks-predictor | 0.3.0rc2 | `92cb1131b4f0ba0b4572d26cb03a1647e239a17f37514c0db1598797119366a8` | — (o próprio pacote) | wheel da release v0.3.0rc2 | True | False |
...
`v0.3.0rc2` (asset conferido por sha256 antes da instalação, `qualification/stocks/RAW_LOGS/cleanroom-final/run35954279991/stocks-runtime-linux-primary/env.log`).
