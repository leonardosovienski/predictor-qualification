"""stocks / fase `baseline` (C3): STACK_BASELINE.json da missão.
...
MISSION_REPOS = ("stocks-predictor", "core-predictor", "predictor-ops")
...
def main() -> None:
    ...
    baseline = {
        "baseline_id": "stocks/STACK_BASELINE",
        "stage": "A",
        "branch": "stocks",
        "common_baseline": "STACK_BASELINE_V1.1",
        "common_core_sha256": "50e8f49859daae6dcdf17164781d1837d8b656796924c35060f8d35855ee36e1",
        "mission_prompt": "prompts/prompt_etapa_a_stocks_rev8.md",
        "collected_at": datetime.now(timezone.utc).isoformat(timespec="seconds"),
        "collector": "qualification/stocks/scripts/collect_mission_baseline.py",
        "environment_collector": {
            "role": "coletor no Windows local (só git + gh api; nada instalado, D-1)",
