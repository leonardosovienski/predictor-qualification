"""brasileirao: gera e confere ATTESTATION_PARTIAL_<phase>.json / QUALIFICATION_ATTESTATION.json.

Fonte única dos estados de gate: qualification/brasileirao/GATES.json (editado a cada fase,
...
# v2.0 e v2.1: os parciais IN_PROGRESS já emitidos valem no núcleo em que foram gravados (C8, C14 "Núcleo (versão)")
CORE_SHA_HIST = ("50e8f49859daae6dcdf17164781d1837d8b656796924c35060f8d35855ee36e1",
                 "a3b4b7bbae9a4419b64b087fd6fd74b91e5a7ffa5860bfe962132b0ddb0a0c9b")
...
def build(result: str) -> dict:
    ...
    return {
        ...
        "common_baseline_id": ledger.get("common_baseline_id", "STACK_BASELINE_V1.1"),
        "common_baseline_sha256": sha(ROOT / "qualification" / "shared" / (ledger.get("common_baseline_id", "STACK_BASELINE_V1.1") + ".json")),
        ...
        "soak_profile_sha256": optional_sha("QUALIFICATION_PROFILE_BR_V1.json"),
        ...
        "gates": gates,
        "findings_file": evidence(["qualification/brasileirao/FINDINGS.json"])[0],
        "counts": counts(),
