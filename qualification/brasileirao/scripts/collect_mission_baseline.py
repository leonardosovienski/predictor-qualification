"""brasileirao / fase `baseline` (C3): STACK_BASELINE.json da missão.

Reaproveita o coletor do STACK_BASELINE_V1 (qualification/shared/scripts/
collect_stack_baseline.py) restrito aos três repos da missão: brasileirao-predictor,
...
MISSION_REPOS = ("brasileirao-predictor", "core-predictor", "predictor-ops")
...
def main() -> None:
    ...
    v1 = json.loads((HERE.parents[2] / "shared" / "STACK_BASELINE_V1.1.json").read_text(encoding="utf-8"))
    v1_heads = {x["repo"]: x["head"] for x in v1["repos"]}
    baseline = {
        "baseline_id": "brasileirao/STACK_BASELINE",
        "stage": "A",
        "branch": "brasileirao",
        "common_baseline": "STACK_BASELINE_V1.1",
        "common_core_sha256": "50e8f49859daae6dcdf17164781d1837d8b656796924c35060f8d35855ee36e1",
        "mission_prompt": "prompts/prompt_etapa_a_brasileirao_rev8.md",
        "collected_at": datetime.now(timezone.utc).isoformat(timespec="seconds"),
        "collector": "qualification/brasileirao/scripts/collect_mission_baseline.py",
