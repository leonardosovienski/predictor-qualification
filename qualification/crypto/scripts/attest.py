"""crypto: gera e confere ATTESTATION_PARTIAL_<phase>.json / QUALIFICATION_ATTESTATION.json.

Fonte única dos estados de gate: qualification/crypto/GATES.json (editado a cada fase,
...
def build(result: str) -> dict:
    ...
    return {
        ...
        "gates": gates,
        "findings_file": evidence(["qualification/crypto/FINDINGS.json"])[0],
        "counts": counts(),
