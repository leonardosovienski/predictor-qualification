...
Imprime JSON: script, argv, exit, módulos GarimpoInvestimentos.*, pacotes externos de interesse."""
import json
import sys
...
INTEREST = ("research_protocol", "research_snapshot", "research_bundle", "cain", "ecosystem",
            "predictor_core", "predictor_ops", "GarimpoInvestimentos")
...
print("\n" + json.dumps({"script": script, "argv": argv, "exit": code, "origins": origins,
                          "research_components_loaded": [m for m in mods if m.startswith("GarimpoInvestimentos.research_")],
